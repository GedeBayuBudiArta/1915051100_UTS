  ...
  <body class="h-vh-100 bg-brandColor2">
    ...
    <h1 class="fg-brandColor2" align="center">Registrasi</h1>
        <div class="form-group cell-6  offset-3">
            ...
            <br><small class="text-muted">Username tidak boleh memakai spasi dan huruf kecil semua</small><br>
        </div>
        <div class="form-group cell-6  offset-3">
            <br><label for="password">Password</label><br>
            <input type="password" id="password" name="password" placeholder="Masukan Password"/>
            <br><small class="text-muted">Password minimal 8 karakter dicampur dengan angka atau simbol</small><br>
        </div>
        <div class="form-group cell-6  offset-3">
            ...
            <br><small class="text-muted">Masukan ulang password untuk konfirmasi</small><br>
        </div>
        <div class="form-group cell-6  offset-3">
